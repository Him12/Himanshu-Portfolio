                ...
                <div className="flex-1 space-y-6">
                  ...
                  <div className="p-6 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950 dark:to-cyan-950 rounded-2xl">
                    <div className="flex items-start space-x-3 mb-4">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-800 dark:text-gray-200 mb-2">Vision</h4>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-800 dark:text-gray-200 mb-2">Problem Solving</h4>
                    ...
                    <div className="p-4 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-xl text-white">
                      ...
                      <ul className="space-y-1">
                        {startup.achievements.map((achievement, i) => (
                          <li key={i} className="text-sm opacity-90">• {achievement}</li>
                        ))}
                      </ul>
                    </div>
                  )}
                  ...
                  {startup.customer_impact && (
                    <div className="p-4 bg-white dark:bg-gray-800 rounded-xl border-2 border-blue-200 dark:border-blue-800">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="font-bold text-gray-800 dark:text-gray-200 mb-2">Customer Impact</h4>
                          <p className="text-gray-600 dark:text-gray-400">{startup.customer_impact}</p>
                        </div>
                      </div>
                    </div>
                  )}
                ...
                <div className="flex-1">
                  {startup.screenshots.length > 0 ? (
                    <div className="grid grid-cols-2 gap-4">
                      {startup.screenshots.slice(0, 4).map((screenshot, i) => (
                        <div
                          key={i}
